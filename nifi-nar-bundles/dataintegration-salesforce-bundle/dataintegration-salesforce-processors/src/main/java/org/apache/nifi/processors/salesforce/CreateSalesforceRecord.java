...
@Tags({"salesforce", "create", "sobject","record"})
@CapabilityDescription("Processor to create salesforce new records. You can supply the required values in their field to"
        + "create a new record in the given salesforce account.")
public class CreateSalesforceRecord extends AbstractSalesForceProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            final ArrayList<String> responseJsonList = getResponse("POST", generateSalesforceURL(endpoint), 
            ...
            if (responseCode.equals("401") && responseMessage.contains("INVALID_SESSION_ID")) {
                ...
                ArrayList<String> responseJsonLists = getResponse("POST", generateSalesforceURL(endpoint), 
                        sfAuthService.getSalesforceAccessToken(), jsonString);
