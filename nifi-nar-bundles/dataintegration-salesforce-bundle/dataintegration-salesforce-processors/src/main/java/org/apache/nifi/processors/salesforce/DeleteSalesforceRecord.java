...
@Tags({"salesforce", "delete", "sobject","record"})
@CapabilityDescription("Processor to delete salesforce records in objects. You can supply the required values in their field to"
        + "delete an existing record in the given salesforce account.")
public class DeleteSalesforceRecord extends AbstractSalesForceProcessor {
    ...
    public static final PropertyDescriptor SOBJECT_ID = new PropertyDescriptor.Builder()
            .name("Salesforce Object Id")
            .description("Enter Salesforce object id to delete corresponding record.")
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .expressionLanguageSupported(true)
            .required(true)
            .build();
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            final ArrayList<String> responseJsonList = getResponse("DELETE", generateSalesforceURL(endpoint), 
            ...
            if (responseCode.equals("401") && responseMessage.contains("INVALID_SESSION_ID")) {
                ...
                ArrayList<String> responseJsonLists = getResponse("DELETE", generateSalesforceURL(endpoint),
