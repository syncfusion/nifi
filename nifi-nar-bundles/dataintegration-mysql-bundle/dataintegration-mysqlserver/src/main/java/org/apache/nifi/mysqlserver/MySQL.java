 ...
 *
 */
@Tags({ "dbcp", "jdbc", "database", "connection", "pooling", "store", "MySQL" })
@CapabilityDescription("Provides Database Connection Pooling Service with MySQL server.")
...
public class MySQL extends AbstractControllerService implements MySQLService {

    public static final PropertyDescriptor SERVER_NAME = new PropertyDescriptor.Builder()
        .name("Server Name")
        .description("MySQL Server Name. May contain hostname or IP address")
        .defaultValue(null)
    ...
    public static final PropertyDescriptor DB_DRIVER_LOCATION = new PropertyDescriptor.Builder()
        .name("MySQL-database-driver-locations")
        ...
        .defaultValue(SQLUpdater.getValue("MySQL"))
        .required(false)
    ...
    public void onConfigured(final ConfigurationContext context) throws InitializationException {
        ...
        final String dburl = "jdbc:mysql://"+ServerName+":"+serverPort+"/"+DbName;
