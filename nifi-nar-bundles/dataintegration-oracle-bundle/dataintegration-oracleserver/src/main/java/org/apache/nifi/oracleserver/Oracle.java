 ...
 */
package org.apache.nifi.oracleserver;
 ...
 *
 */
@Tags({ "dbcp", "jdbc", "database", "connection", "pooling", "store", "Oracle" })
@CapabilityDescription("Provides Database Connection Pooling Service with Oracle server.")
...
public class Oracle extends AbstractControllerService implements OracleService {

    public static final PropertyDescriptor SERVER_NAME = new PropertyDescriptor.Builder()
        .name("Server Name")
        .description("Oracle Server Name. May contain hostname or IP address")
        .defaultValue(null)
    ...
    public static final PropertyDescriptor SERVER_PORT = new PropertyDescriptor.Builder()
        .name("Server Port")
        .description("Port number of the Oracle server")
        .defaultValue("1521")
        .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
        .required(true)
        .expressionLanguageSupported(true)
    ...
    public static final PropertyDescriptor DB_DRIVER_LOCATION = new PropertyDescriptor.Builder()
        .name("Oracle-database-driver-locations")
        ...
        .defaultValue(SQLUpdater.getValue("Oracle"))
        .required(false)
    ...
    public void onConfigured(final ConfigurationContext context) throws InitializationException {
        ...
        final String dburl = "jdbc:oracle:thin:@"+ServerName+":"+serverPort+":"+DbName;
