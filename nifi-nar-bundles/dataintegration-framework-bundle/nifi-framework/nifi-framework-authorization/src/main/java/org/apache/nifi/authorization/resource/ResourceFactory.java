...
public final class ResourceFactory {
    ...
    private final static Resource CONFIGURATION_RESOURCE = new Resource() {
        @Override
        public String getIdentifier() {
            return ResourceType.Configuration.getValue();
        }
    ...
    /**
     * Gets the Resource for accessing Configuration files which includes creating, modifying, and deleting configuration files.
     *
     * @return The Resource for accessing Configuration Files
     */
    public static Resource getConfigurationResource() {
