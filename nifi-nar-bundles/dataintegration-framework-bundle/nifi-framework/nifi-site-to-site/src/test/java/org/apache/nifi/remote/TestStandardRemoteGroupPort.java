...
public class TestStandardRemoteGroupPort {
    ...
    private static final String REMOTE_CLUSTER_URL = "http://node0.example.com:60017/dataintegration";
    ...
    public void testSendHttp() throws Exception {
        ...
        final String peerUrl = "https://node1.example.com:60017/dataintegration";
        final PeerDescription peerDescription = new PeerDescription("node1.example.com", 60017, true);
        final HttpCommunicationsSession commsSession = new HttpCommunicationsSession();
        commsSession.setUserDn("nifi.node1.example.com");
        final Peer peer = new Peer(peerDescription, commsSession, peerUrl, REMOTE_CLUSTER_URL);

        final String flowFileEndpointUri = "https://node1.example.com:60017/dataintegration-api/output-ports/port-id/transactions/transaction-id/flow-files";
    ...
    private void testSendBatch(final int[] expectedNumberOfPackets) throws Exception {
        ...
        final String peerUrl = "http://node1.example.com:60017/dataintegration";
        final PeerDescription peerDescription = new PeerDescription("node1.example.com", 60017, false);
        final HttpCommunicationsSession commsSession = new HttpCommunicationsSession();
        final Peer peer = new Peer(peerDescription, commsSession, peerUrl, REMOTE_CLUSTER_URL);

        final String flowFileEndpointUri = "http://node1.example.com:60017/dataintegration-api/output-ports/port-id/transactions/transaction-id/flow-files";
