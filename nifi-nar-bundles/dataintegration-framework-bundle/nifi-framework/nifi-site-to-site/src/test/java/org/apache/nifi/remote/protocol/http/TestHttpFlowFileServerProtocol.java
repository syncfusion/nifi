...
public class TestHttpFlowFileServerProtocol {
    ...
    private Peer getDefaultPeer(final String transactionId) {
        final PeerDescription description = new PeerDescription("peer-host", 60017, false);
        ...
        final String peerUrl = "http://peer-host:60017/";
    ...
    public void testTransferOneFile() throws Exception {
        ...
        final String endpointUri = "https://remote-host:8443/dataintegration-api/output-ports/port-id/transactions/"
    ...
    public void testReceiveOneFile() throws Exception {
        ...
        final String endpointUri = "https://remote-host:8443/dataintegration-api/input-ports/port-id/transactions/"
                + transactionId + "/flow-files";
