...
public class TestRemoteProcessGroupDTO {
    ...
    public void testGetTargetUriAndUris() {
        ...
        dto.setTargetUris("http://node1:60017/dataintegration, http://node2:60017/dataintegration");
        assertEquals("If targetUris are set but targetUri is not, it should returns the first uru of the targetUris",
                "http://node1:60017/dataintegration", dto.getTargetUri());
        assertEquals("http://node1:60017/dataintegration, http://node2:60017/dataintegration", dto.getTargetUris());
