...
public class CurrentUserEntity extends Entity {
    ...
    private PermissionsDTO configurationsPermissions;
    ...
    /**
     * @return permissions for accessing configurations
     */
    @ApiModelProperty("Permissions for accessing configuration files.")
    public PermissionsDTO getConfigurationPermissions() {
        return configurationsPermissions;
    }

    public void setConfigurationPermissions(PermissionsDTO configurationsPermissions) {
        this.configurationsPermissions = configurationsPermissions;
    }
