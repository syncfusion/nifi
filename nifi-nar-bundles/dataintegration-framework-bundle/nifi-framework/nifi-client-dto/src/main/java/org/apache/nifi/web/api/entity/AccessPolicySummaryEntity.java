...
public class AccessPolicySummaryEntity extends ComponentEntity {
    ...
    private boolean isExistInGroup;
    ...
    /**
     * Used to check whether it is exist in group or not
     * 
     * @return 
     */
    public boolean getIsExistInGroup() {
        return isExistInGroup;
    }
    
    public void setIsExistInGroup(boolean isExistInGroup) {
        this.isExistInGroup = isExistInGroup;
    }
