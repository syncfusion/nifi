...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="shortcut icon" href="../dataintegration/images/nifi16.ico"/>
        <title>Data Integration Documentation</title>
        <script type="text/javascript" src="../dataintegration/assets/jquery/dist/jquery.min.js"></script>
        <script type="text/javascript" src="../dataintegration-docs/js/application.js"></script>
    ...
    <body id="documentation-body">
        ...
        <div id="documentation-header" class="documentation-header">
            ...
            <div id="header-contents">
                <div id="nf-title">Data Integration Documentation</div>
		...
		<!--          Css for viewing appropriate scrollbar in the Data studio for Nifi documentaion page   -->
        <style>
            ::-webkit-scrollbar
            {
