...
public class TestDataTransferResource {
    ...
    private HttpServletRequest createCommonHttpServletRequest() {
        ...
        doReturn(new StringBuffer("http://nifi.example.com:60017")
                .append("/dataintegration-api/data-transfer/output-ports/port-id/transactions/tx-id/flow-files"))
    ...
    public void testCreateTransaction() throws Exception {
        ...
        final String locationUriStr = "http://localhost:60017/dataintegration-api/data-transfer/input-ports/port-id/transactions/transaction-id";
