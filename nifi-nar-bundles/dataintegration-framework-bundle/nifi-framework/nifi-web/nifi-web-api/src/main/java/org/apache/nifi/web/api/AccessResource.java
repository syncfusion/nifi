...
public class AccessResource extends ApplicationResource {
    ...
    public static String IsRestartEnable = "false";
    ...
    public Response createAccessToken(
        ...
        LoginAuthenticationToken loginAuthenticationToken = null;
        ...
        try {
            if (properties.getProperty(NiFiProperties.SECURITY_USER_LOGIN_IDENTITY_PROVIDER) != null
                ...
                if (username.equals(SyncfusionConstants.Syncfusion) && password.equals(SyncfusionConstants.DefaultUMSPassword)) {
                    ...
                    final AuthenticationResponse authenticationResponse = loginIdentityProvider.authenticate(new LoginCredentials(codeStr, getAccessToken(baseUrl, username, password)));
        ...
        } catch (final InvalidLoginCredentialsException ex) {
            throw new IllegalArgumentException("The supplied username and password are not valid.", ex);
        }
    ...
    /**
     * Gets the value of a cookie matching the specified name. If no cookie with
     * that name exists, null is returned.
     *
     * @param cookies the cookies
     * @param name the name of the cookie
     * @return the value of the corresponding cookie, or null if the cookie does
     * not exist
     */
    ...
    private String getAccessToken(String umsBaseUrl, String username, String password) throws IOException {
