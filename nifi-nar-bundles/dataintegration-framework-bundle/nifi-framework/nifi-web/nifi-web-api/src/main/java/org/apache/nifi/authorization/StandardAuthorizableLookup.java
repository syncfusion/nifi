...
import org.apache.nifi.authorization.resource.ConfigurationAuthorizable;
...
class StandardAuthorizableLookup implements AuthorizableLookup {
    ...
    private static final ConfigurationAuthorizable CONFIGURATION_AUTHORIZABLE = new ConfigurationAuthorizable();
    ...
    @Override
    public Authorizable getConfiguration() {
        return CONFIGURATION_AUTHORIZABLE;
    }
