    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            if (!properties.isNode()) {
                ...
                if(properties.getProperty(NiFiProperties.WEB_HTTPS_HOST)!=null&&
                        properties.getProperty(NiFiProperties.WEB_HTTPS_PORT)!=null &&
                        !"".equals(properties.getProperty(NiFiProperties.WEB_HTTPS_HOST))&&
                        !"".equals(properties.getProperty(NiFiProperties.WEB_HTTPS_PORT))){
                    authorizer = ctx.getBean("authorizer", Authorizer.class);
                    authorizer.populateDefaultGroups();
                }
