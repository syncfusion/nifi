...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="../dataintegration/images/data-integration.ico"/>
        ...
        <link rel="stylesheet" href="../dataintegration/fonts/flowfont/flowfont.css" type="text/css" />
         <link rel="stylesheet" href="../dataintegration/fonts/Tab/Tabfont.css" type="text/css" />
        <link rel="stylesheet" href="../dataintegration/assets/font-awesome/css/font-awesome.min.css" type="text/css" />
        <link rel="stylesheet" href="../dataintegration/css/message-pane.css" type="text/css" />
        <link rel="stylesheet" href="../dataintegration/css/syncfusion/syncfusion-message-pane.css" type="text/css" />
        <link rel="stylesheet" href="../dataintegration/css/message-page.css" type="text/css" />
                        ...
                        if (currentLocation !== option.value) {
                            ...
                            var getAccessToken = $$.Deferred(function (deferred) {
                                if (nf.Storage.hasItem('jwt')) {
                                    $$.ajax({
                                        type: 'POST',
                                        url: '../dataintegration-api/access/ui-extension-token'
                                    }).done(function (token) {
