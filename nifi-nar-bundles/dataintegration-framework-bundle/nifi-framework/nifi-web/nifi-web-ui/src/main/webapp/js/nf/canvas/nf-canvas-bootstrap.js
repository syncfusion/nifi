...
/* global define, module, require, exports, nfCustomJarConfiguration */
        ...
        if (nfCanvas.SUPPORTS_SVG) {
            ...
            userXhr.done(function () {
                ...
                $.when(configXhr, nfClusterSummary.loadClusterSummary(), userXhr, clientXhr).done(function (configResult) {
                    ...
                    nfDataPreviewDialog.init(nfContextMenu);
                    ...
                    nf.CustomJarConfiguration.init();
                    if(nfCommon.isSecured())
                    {
                        nf.SecurityManagement.init();
                        nf.AddPolicyToUsers.init();
                        nf.ComponentPolicy.init();
                        nf.CreateComponentPolicy.init();
                    }
