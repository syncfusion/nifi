...
(function (root, factory) {
    ...
    var mySelf = function () {
        ...
        var config = {
            sliderTickCount: 75,
            urls: {
                lineage: '../dataintegration-api/provenance/lineage'
                ...
                if (parents.length === 1) {
                    immediate = immediate.sort(function (one, two) {
                        ...
                        if (oneNode.outgoing.length > 0 && twoNode.outgoing.length > 0) {
                            oneIndex = children.indexOf(oneNode.outgoing[0].target.id);
                            twoIndex = children.indexOf(twoNode.outgoing[0].target.id);
                        ...
                        if (oneNode.incoming.length > 0 && twoNode.incoming.length > 0) {
                            oneIndex = oneNode.incoming[0].source.index;
                            twoIndex = twoNode.incoming[0].source.index;
                            if (oneIndex !== twoIndex) {
                                return oneIndex - twoIndex;
                            }
                        }
