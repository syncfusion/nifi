    ...
    return function (serviceProvider) {
        ...
        RemoteProcessGroupComponent.prototype = {
            ...
            dropHandler: function (pt) {
             /**
             *Commented to override drop functionality of remote process group.
             */   
          //  this.promptForRemoteProcessGroupUri(pt);
            ...
            dragIcon: function (event) {
                return $('<div class="icon icon-group-remote-add RestrictDragComponent" style="margin-top: -2px;margin-left: -14px;font-Size: 12px;position: relative;color:#484D4E;height: 27.5px ! important;width: 130px ! important;display: inline-flex; line-height:19px;background-color:#C9F0F8;border-radius:4px; border:2px solid #84D2F9"><span style="padding-left: 10px;padding-top: 2px;font-size: 11px;">Remote Process</span></div>');  
            },
