...
(function (root, factory) {
    ...
    return function (serviceProvider) {
        ...
        var config = {
            search: 'Search',
            urls: {
                search: '../dataintegration-api/flow/search-results',
                status: '../dataintegration-api/flow/status'
            }
        };
        ...
        function FlowStatusCtrl() {
            ...
            this.bulletins = {
                 ...
                 *
                 * @param response  The controller bulletins returned from the `../dataintegration-api/controller/bulletins` endpoint.
                 */
        ...
        FlowStatusCtrl.prototype = {
             ...
             *
             * @param status  The controller status returned from the `../dataintegration-api/flow/status` endpoint.
             */
