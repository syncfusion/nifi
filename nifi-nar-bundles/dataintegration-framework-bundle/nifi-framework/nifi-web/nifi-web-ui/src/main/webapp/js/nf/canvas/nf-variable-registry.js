...
(function (root, factory) {
    ...
    var showVariables = function (processGroupId, variableToSelect) {
        return $.ajax({
            type: 'GET',
            url: '../dataintegration-api/process-groups/' + encodeURIComponent(processGroupId) + '/variable-registry',
            dataType: 'json'
    ...
    var submitUpdateRequest = function (processGroupId, variables) {
        ...
        return $.ajax({
            ...
            url: '../dataintegration-api/process-groups/' + encodeURIComponent(processGroupId) + '/variable-registry/update-requests',
            dataType: 'json',
    ...
    var getUpdateRequest = function (processGroupId, updateRequestId) {
        return $.ajax({
            type: 'GET',
            url: '../dataintegration-api/process-groups/' + encodeURIComponent(processGroupId) + '/variable-registry/update-requests/' + encodeURIComponent(updateRequestId),
            dataType: 'json'
        }).fail(nfErrorHandler.handleAjaxError);
    };
