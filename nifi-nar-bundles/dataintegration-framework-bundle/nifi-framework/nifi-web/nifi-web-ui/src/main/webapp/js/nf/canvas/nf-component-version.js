...
(function (root, factory) {
    ...
    var getTypeUri = function (componentEntity) {
        if (componentEntity.type === 'ReportingTask') {
            return '../dataintegration-api/flow/reporting-task-types';
        } else if (componentEntity.type === 'ControllerService') {
            return '../dataintegration-api/flow/controller-service-types';
        } else {
            return '../dataintegration-api/flow/processor-types';
        }
    };
