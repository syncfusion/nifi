...
(function (root, factory) {
    ...
    var nfProvenance = function (provenanceTableCtrl) {
        ...
        var config = {
            urls: {
                clusterSummary: '../dataintegration-api/flow/cluster/summary',
                banners: '../dataintegration-api/flow/banners',
                about: '../dataintegration-api/flow/about',
        ...
        var loadAbout = function () {
            ...
            return $.ajax({
                ...
                var provenanceTitle = ' Data Provenance';
                ...
                $.when(loadAbout(), loadCurrentUser(), detectedCluster()).done(function () {
                    ...
                    provenanceTableCtrl.init(isClustered).done(function () {
                        ...
                        $(window).on('resize', function (e) {
                            ...
                            for (var j = 0, gridLength = gridElements.length; j < gridLength; j++) {
