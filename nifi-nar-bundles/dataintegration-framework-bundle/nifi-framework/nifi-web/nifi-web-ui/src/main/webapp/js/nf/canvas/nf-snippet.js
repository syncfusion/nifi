...
(function (root, factory) {
    ...
    var config = {
        urls: {
            snippets: '../dataintegration-api/snippets',
            processGroups: '../dataintegration-api/process-groups'
        }
    };
    ...
    return {
         ...
         */
        copy: function (snippetId, origin, createdGroupId) {
            ...
            return $.ajax({
                type: 'POST',
                url: config.urls.processGroups + '/' + encodeURIComponent(createdGroupId) + '/snippet-instance',
