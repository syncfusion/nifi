            ...
            <div id="flowfile-details-tab-content" class="details-tab">
                ...
                <div class="settings-right">
                    ...
                    <div id="flowfile-content-details" class="content-details">
                        ...
                        <div class="flowfile-detail">
                            <div id="content-download" class="secondary-button download fa fa-download button-icon"><span>Download</span></div>
                            <div id="content-view" class="secondary-button view fa fa-eye button-icon hidden"><span>View</span></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
