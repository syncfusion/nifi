...
<div id="cluster" class="cluster-container">
    <div id="cluster-header-and-filter">
        <div id="cluster-header-text" class="cluster-header">Cluster</div>
    </div>
    <div id="cluster-tabs" class="tab-container"></div>
    <div id="cluster-tabs-content" class="cluster-tabs">
...
<div id="cluster-refresh-container" class="cluster-refresh-section">
    ...
    <div id="cluster-last-refreshed-container" class="last-refreshed-container">
        Last updated:&nbsp;<span id="cluster-last-refreshed" class="last-refreshed"></span>
    </div>
