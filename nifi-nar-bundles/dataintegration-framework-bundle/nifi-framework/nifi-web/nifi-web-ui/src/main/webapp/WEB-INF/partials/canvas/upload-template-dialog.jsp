        ...
        <div id="select-template-container">
            <div id="template-browse-container">
                ...
                <div id="select-template-button">
                   <button class="fa fa-search" onclick="document.getElementById('template-file-field').click()" style="padding: 0px;"></button>
                    <form id="template-upload-form" enctype="multipart/form-data" method="post">
                                 <input type="file" name="template" id="template-file-field" title="Browse" style="width: 28px;display: none"/>
                    </form>
                </div>
            </div>
        </div>
