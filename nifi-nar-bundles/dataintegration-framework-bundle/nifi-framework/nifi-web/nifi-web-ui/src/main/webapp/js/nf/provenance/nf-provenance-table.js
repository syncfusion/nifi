...
(function (root, factory) {
    ...
    var nfProvenanceTable = function (provenanceLineageCtrl) {
        ...
        var config = {
            ...
            urls: {
                searchOptions: '../dataintegration-api/provenance/search-options',
                replays: '../dataintegration-api/provenance-events/replays',
                provenance: '../dataintegration-api/provenance',
                provenanceEvents: '../dataintegration-api/provenance-events/',
                clusterSearch: '../dataintegration-api/flow/cluster/search-results',
                d3Script: 'js/d3/d3.min.js',
                lineageScript: 'js/nf/provenance/nf-provenance-lineage.js',
                uiExtensionToken: '../dataintegration-api/access/ui-extension-token',
        ...
        var loadProvenanceResults = function (provenance, provenanceTableCtrl) {
            ...
            if (nfCommon.isDefinedAndNotNull(provenanceResults.provenanceEvents)) {
                ...
                if (isBlankQuery(provenanceRequest)) {
                    message = 'Showing the most recent ';
