...
(function (root, factory) {
    ...
    var createPortOption = function (container, port, portType) {
        ...
        var batchSettingsContainer = $('<div class="batch-settings-container"></div>')
            .append($('<div class="setting-name">Batch Settings'+ '<div class="processor-setting batch-settings-info fa fa-question-circle"></div></div>'))
