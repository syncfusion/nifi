...
<div id="settings" class="hidden">
    <div id="settings-header-text" class="settings-header-text">Settings</div>
            ...
            <div id="general-settings-tab-content" class="configuration-tab">
                <div id="general-settings">
                    ...
                    <div class="setting reset-settings">
                        <div class="setting-name reset-label">
                          Reset processor categorization under component toolbar to default. 
                          <div class="fa fa-question-circle" alt="Info" title="Reset processor categorization under component toolbar to default."></div>
                        </div>
                        <div id="settings-reset" class="button">Reset</div>
                        <div class="read-only setting-field">
                            <span id="read-only-maximum-event-driven-thread-count-field"></span>
                        </div>
                    </div>
                </div>
                <div class="settings-loader-icon" style="height:50px;width:49px;background-image: url(images/waitingpopup.gif);position:absolute;z-index: 2;margin-left:48%;float: left;display:none"></div>
            </div>
