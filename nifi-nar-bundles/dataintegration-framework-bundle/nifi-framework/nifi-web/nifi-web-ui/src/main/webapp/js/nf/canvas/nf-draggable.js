                ...
                .on('drag', function () {
                    ...
                    if (dragSelection.empty()) {
                        ...
                        selection.each(function (d) {
                            ...
                            if($("#"+id).hasClass("processor")||$("#"+id).hasClass("remote-process-group")){
                            if($("#"+id).hasClass("minimized"))
                            {
                            componentMaxX = d.position.x + d.minimizedDimensions.width;
                            componentMaxY = d.position.y + d.minimizedDimensions.height;   
                            }
                            }
                            else if($("#"+id).hasClass("process-group")){
                            if($("#"+id).hasClass("minimized-process-group"))
                            {
                            componentMaxX = d.position.x + d.minimizedDimensions.width;
                            componentMaxY = d.position.y + d.minimizedDimensions.height;   
                            } 
