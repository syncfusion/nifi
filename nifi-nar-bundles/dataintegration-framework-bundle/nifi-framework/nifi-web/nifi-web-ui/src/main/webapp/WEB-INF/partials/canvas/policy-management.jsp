...
<div id="policy-management">
    <div class="dialog-content dialog-contentStyle">
    <div id="policy-controls-container">
        ...
        <div id="component-policy-controls" class="hidden policy-controls">
            ...
            <div id="selected-policy-component-permissions" class="hidden"></div>
...
<div id="security-user-view-container">
<span class="link" id="user-view">
   User based view
</span>
</div>   
