...
(function (root, factory) {
    ...
    var policyTypeListing = [{
        ...
        text: 'access configuration files',
        value: 'configurations',
        description: 'Allows users to view/modify the configuration files'
    }, {
    ...
    var nfCommon = {
        ...
        setAnonymousUserLabel: function () {
            ...
            if(location.protocol === "https:")
                $('#current-user').text(nfCommon.ANONYMOUS_USER_TEXT).attr("title", nfCommon.ANONYMOUS_USER_TEXT).show();  
        },
        ...
        /**
         * Determines whether the current user can configuration files.
         *
         * @returns {boolean}
         */
        canAccessConfigurations: function () {
            if (nfCommon.isDefinedAndNotNull(nfCommon.currentUser)) {
                return nfCommon.currentUser.configurationPermissions.canRead === true;
            } else {
                return false;
            }
        },
        ...
        /**
         * Determines whether the current user can modify configurations.
         *
         * @returns {boolean}
         */
        canModifyConfigurations: function () {
            if (nfCommon.isDefinedAndNotNull(nfCommon.currentUser)) {
                return nfCommon.currentUser.configurationPermissions.canRead === true && nfCommon.currentUser.configurationPermissions.canWrite === true;
            } else {
                return false;
            }
        },
        ...
        isContentViewConfigured: function () {
            var contentViewerUrl = $('#dataintegration-content-viewer-url').text();
        ...
        isUMS: function (){
            return nf.SecurityCommon.isUMP();
        },
        
        umsApplications: undefined,
        getUMSApplications: function (){
            nf.Common.umsApplications = nf.SecurityCommon.getUMSApplicationDetails();
        }
    };
