...
(function (root, factory) {
    ...
    return function (serviceProvider) {
        ...
        var config = {
            urls: {
                helpDocument: '../dataintegration-docs/documentation',
                controllerAbout: '../dataintegration-api/flow/about'
            }
        };
        ...
        function GlobalMenuCtrl(serviceProvider) {
            ...
            /**
         * The security menu item controller.
         */
        this.security = {

            /**
             * The security menu item's shell controller.
             */
            shell: {

                /**
                 * Launch the security shell.
                 */
                launch: function () {
                    if (nfCommon.canAccessTenants()) {
                        nf.SecurityManagement.OpenSecurityDialog();
                    }
                }
            }
        };
                ...
                init: function () {
                    ...
                    $.ajax({
                        ...
                        if (!nfCommon.isBlank(aboutDetails.contentViewerUrl)) {
                            $('#dataintegration-content-viewer-url').text(aboutDetails.contentViewerUrl);
                ...
                modal: {
                    ...
                    init: function () {
                        ...
                        this.getElement().modal({
                            ...
                            headerText: 'About Syncfusion Data Integration Platform',
                            handler: {
                                resize: resizeAbout
                            },
                            buttons: [{
