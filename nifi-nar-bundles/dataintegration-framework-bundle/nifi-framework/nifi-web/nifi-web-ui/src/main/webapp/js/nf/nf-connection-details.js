...
(function (root, factory) {
    ...
    var initializeSourceProcessor = function (groupId, groupName, source) {
        return $.Deferred(function (deferred) {
            $.ajax({
                type: 'GET',
                url: '../dataintegration-api/processors/' + encodeURIComponent(source.id),
                dataType: 'json'
    ...
    var initializeRemoteSourcePort = function (groupId, groupName, source) {
        return $.Deferred(function (deferred) {
            $.ajax({
                type: 'GET',
                url: '../dataintegration-api/remote-process-groups/' + encodeURIComponent(source.groupId),
                dataType: 'json'
            }).done(function (response) {
    ...
    var initializeLocalSourcePort = function (groupId, groupName, source) {
        return $.Deferred(function (deferred) {
            if (groupId === source.groupId) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '../dataintegration-api/process-groups/' + encodeURIComponent(source.groupId),
                    dataType: 'json'
                }).done(function (response) {
    ...
    var initializeDestinationProcessor = function (groupId, groupName, destination) {
        return $.Deferred(function (deferred) {
            $.ajax({
                type: 'GET',
                url: '../dataintegration-api/processors/' + encodeURIComponent(destination.id),
                dataType: 'json'
            }).done(function (response) {
                var processor = response.component;
                var processorName = $('<div class="label"></div>').text(processor.name).addClass('ellipsis').attr('title', processor.name);
    ...
    var initializeDestinationRemotePort = function (groupId, groupName, destination) {
        return $.Deferred(function (deferred) {
            $.ajax({
                type: 'GET',
                url: '../dataintegration-api/remote-process-groups/' + encodeURIComponent(destination.groupId),
                dataType: 'json'
            }).done(function (response) {
                var remoteProcessGroup = response.component;
    ...
    var initializeDestinationLocalPort = function (groupId, groupName, destination) {
        return $.Deferred(function (deferred) {
            if (groupId === destination.groupId) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '../dataintegration-api/process-groups/' + encodeURIComponent(destination.groupId),
                    dataType: 'json'
                }).done(function (response) {
                    var processGroup = response.component;
    ...
    return {
        ...
        showDetails: function (groupId, connectionId) {
            ...
            var groupXhr = $.ajax({
                type: 'GET',
                url: '../dataintegration-api/flow/process-groups/' + encodeURIComponent(groupId),
                dataType: 'json'
            });
            ...
            var connectionXhr = $.ajax({
                type: 'GET',
                url: '../dataintegration-api/connections/' + encodeURIComponent(connectionId),
                dataType: 'json'
            });
