...
public class ReportingTaskEndpointMerger  extends AbstractSingleEntityEndpoint<ReportingTaskEntity> implements EndpointResponseMerger {
    public static final String REPORTING_TASKS_URI = "/dataintegration-api/controller/reporting-tasks";
    public static final Pattern REPORTING_TASK_URI_PATTERN = Pattern.compile("/dataintegration-api/reporting-tasks/[a-f0-9\\-]{36}");
