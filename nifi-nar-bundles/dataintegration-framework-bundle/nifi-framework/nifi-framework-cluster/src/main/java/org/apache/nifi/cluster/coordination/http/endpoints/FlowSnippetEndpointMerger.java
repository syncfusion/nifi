...
public class FlowSnippetEndpointMerger implements EndpointResponseMerger {
    public static final Pattern TEMPLATE_INSTANCE_URI_PATTERN = Pattern.compile("/dataintegration-api/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))/template-instance");
    public static final Pattern FLOW_SNIPPET_INSTANCE_URI_PATTERN = Pattern.compile("/dataintegration-api/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))/snippet-instance");
