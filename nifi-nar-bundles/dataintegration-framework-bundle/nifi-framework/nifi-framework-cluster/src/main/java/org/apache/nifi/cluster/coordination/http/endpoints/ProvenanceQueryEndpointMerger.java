...
public class ProvenanceQueryEndpointMerger implements EndpointResponseMerger {
    public static final String PROVENANCE_URI = "/dataintegration-api/provenance";
    public static final Pattern PROVENANCE_QUERY_URI = Pattern.compile("/dataintegration-api/provenance/[a-f0-9\\-]{36}");
