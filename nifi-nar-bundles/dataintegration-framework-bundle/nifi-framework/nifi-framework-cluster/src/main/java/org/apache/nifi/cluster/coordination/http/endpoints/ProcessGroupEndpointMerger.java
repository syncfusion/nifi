...
public class ProcessGroupEndpointMerger extends AbstractSingleEntityEndpoint<ProcessGroupEntity> implements EndpointResponseMerger {
    public static final Pattern PROCESS_GROUP_URI_PATTERN = Pattern.compile("/dataintegration-api/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))");
    public static final Pattern CONTROLLER_ARCHIVE_URI_PATTERN = Pattern.compile("/dataintegration-api/controller/archive");
