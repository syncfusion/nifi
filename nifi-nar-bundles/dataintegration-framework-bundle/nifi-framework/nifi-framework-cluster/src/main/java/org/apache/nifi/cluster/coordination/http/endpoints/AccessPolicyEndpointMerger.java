...
public class AccessPolicyEndpointMerger extends AbstractSingleEntityEndpoint<AccessPolicyEntity> implements EndpointResponseMerger {
    public static final Pattern ACCESS_POLICIES_URI_PATTERN = Pattern.compile("/dataintegration-api/policies");
    public static final Pattern ACCESS_POLICY_URI_PATTERN = Pattern.compile("/dataintegration-api/policies/[a-f0-9\\-]{36}");
    public static final Pattern ACCESS_POLICY_LOOKUP_URI_PATTERN = Pattern.compile("/dataintegration-api/policies/(?:read|write)/(?:[\\w-]+?/?)+");
