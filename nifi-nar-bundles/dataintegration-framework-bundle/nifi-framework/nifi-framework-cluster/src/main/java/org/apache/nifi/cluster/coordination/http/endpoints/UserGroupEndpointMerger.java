...
public class UserGroupEndpointMerger extends AbstractSingleEntityEndpoint<UserGroupEntity> implements EndpointResponseMerger {
    public static final Pattern USER_GROUPS_URI_PATTERN = Pattern.compile("/dataintegration-api/tenants/user-groups");
    public static final Pattern USER_GROUP_URI_PATTERN = Pattern.compile("/dataintegration-api/tenants/user-groups/[a-f0-9\\-]{36}");
