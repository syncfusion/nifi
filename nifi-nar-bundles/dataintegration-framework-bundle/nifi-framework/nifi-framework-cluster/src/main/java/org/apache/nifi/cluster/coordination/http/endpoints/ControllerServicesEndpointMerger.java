...
public class ControllerServicesEndpointMerger implements EndpointResponseMerger {
    public static final String CONTROLLER_SERVICES_URI = "/dataintegration-api/flow/controller/controller-services";
    public static final Pattern PROCESS_GROUPS_CONTROLLER_SERVICES_URI = Pattern.compile("/dataintegration-api/flow/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))/controller-services");
