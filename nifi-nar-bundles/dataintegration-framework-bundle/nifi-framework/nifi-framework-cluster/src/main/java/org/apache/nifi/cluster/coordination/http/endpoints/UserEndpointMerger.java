...
public class UserEndpointMerger extends AbstractSingleEntityEndpoint<UserEntity> implements EndpointResponseMerger {
    public static final Pattern USERS_URI_PATTERN = Pattern.compile("/dataintegration-api/tenants/users");
    public static final Pattern USER_URI_PATTERN = Pattern.compile("/dataintegration-api/tenants/users/[a-f0-9\\-]{36}");
