...
public class LabelEndpointMerger extends AbstractSingleEntityEndpoint<LabelEntity> {
    public static final Pattern LABELS_URI_PATTERN = Pattern.compile("/dataintegration-api/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))/labels");
    public static final Pattern LABEL_URI_PATTERN = Pattern.compile("/dataintegration-api/labels/[a-f0-9\\-]{36}");
