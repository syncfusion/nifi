...
public class ControllerServiceEndpointMerger extends AbstractSingleEntityEndpoint<ControllerServiceEntity> implements EndpointResponseMerger {
    public static final String CONTROLLER_CONTROLLER_SERVICES_URI = "/dataintegration-api/controller/controller-services";
    public static final Pattern PROCESS_GROUPS_CONTROLLER_SERVICES_URI = Pattern.compile("/dataintegration-api/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))/controller-services");
    public static final Pattern CONTROLLER_SERVICE_URI_PATTERN = Pattern.compile("/dataintegration-api/controller-services/[a-f0-9\\-]{36}");
