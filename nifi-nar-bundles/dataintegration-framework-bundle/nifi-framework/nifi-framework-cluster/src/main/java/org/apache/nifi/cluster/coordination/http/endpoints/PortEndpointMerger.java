...
public class PortEndpointMerger extends AbstractSingleEntityEndpoint<PortEntity> implements EndpointResponseMerger {
    public static final Pattern INPUT_PORTS_URI_PATTERN = Pattern.compile("/dataintegration-api/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))/input-ports");
    public static final Pattern INPUT_PORT_URI_PATTERN = Pattern.compile("/dataintegration-api/input-ports/[a-f0-9\\-]{36}");

    public static final Pattern OUTPUT_PORTS_URI_PATTERN = Pattern.compile("/dataintegration-api/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))/output-ports");
    public static final Pattern OUTPUT_PORT_URI_PATTERN = Pattern.compile("/dataintegration-api/output-ports/[a-f0-9\\-]{36}");
