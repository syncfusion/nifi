...
public class ConnectionEndpointMerger extends AbstractSingleEntityEndpoint<ConnectionEntity> implements EndpointResponseMerger {
    public static final Pattern CONNECTIONS_URI_PATTERN = Pattern.compile("/dataintegration-api/process-groups/(?:(?:root)|(?:[a-f0-9\\-]{36}))/connections");
    public static final Pattern CONNECTION_URI_PATTERN = Pattern.compile("/dataintegration-api/connections/[a-f0-9\\-]{36}");
