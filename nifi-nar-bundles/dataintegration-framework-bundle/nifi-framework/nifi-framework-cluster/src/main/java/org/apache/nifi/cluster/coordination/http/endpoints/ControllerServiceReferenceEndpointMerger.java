...
public class ControllerServiceReferenceEndpointMerger implements EndpointResponseMerger {
    public static final Pattern CONTROLLER_SERVICE_REFERENCES_URI_PATTERN = Pattern.compile("/dataintegration-api/controller-services/node/[a-f0-9\\-]{36}/references");
