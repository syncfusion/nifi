...
public class FingerprintFactoryTest {
    ...
    public void testRemoteProcessGroupFingerprintRaw() throws Exception {
        ...
        when(component.getTargetUri()).thenReturn("http://node1:60017/dataintegration");
        when(component.getTargetUris()).thenReturn("http://node1:60017/dataintegration, http://node2:60017/dataintegration");
        ...
        final String expected = "id" +
                "http://node1:60017/dataintegration, http://node2:60017/dataintegration" +
                "eth0" +
                "10 sec" +
                "30 sec" +
                "RAW" +
    ...
    public void testRemotePortFingerprint() throws Exception {
        ...
        when(groupComponent.getTargetUri()).thenReturn("http://node1:60017/dataintegration");
