...
@CapabilityDescription("Processor to share data in LinkedIn. "
        + "Specify the required API endpoints, access token, message to be shared, and content type for the response.")
...
public final class PostLinkedIn extends AbstractProcessor {
    ...
    public static final PropertyDescriptor PROP_API_METHOD = new PropertyDescriptor
     ...
     public static final PropertyDescriptor PROP_ACCESS_TOKEN = new PropertyDescriptor
      ...
      public static final PropertyDescriptor MESSAGE = new PropertyDescriptor.Builder()
            .name("Message")
            .description("Specify the message to be shared. Supports JSON and XML.")
            .required(true)
    ...
    public static final Relationship REL_SUCCESS = new Relationship.Builder()
            .name("success")
            .description("FlowFiles are routed to success if data is shared successfully in LinkedIn.")
            .build();

    public static final Relationship REL_FAILURE = new Relationship.Builder()
            .name("failure")
            .description("FlowFiles are routed to failure if data sharing fails in LinkedIn.")
            .build();
  private static final List<PropertyDescriptor> PROPERTIES = Collections.unmodifiableList(Arrays.asList(
    ...
    public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException {
        ...
        try {            
            final ArrayList<String> responseJsonList = doPostRequest(url, accessToken,message);
    ...
    private ArrayList<String> doPostRequest(String url, String accessToken, String message)
            throws Exception {
