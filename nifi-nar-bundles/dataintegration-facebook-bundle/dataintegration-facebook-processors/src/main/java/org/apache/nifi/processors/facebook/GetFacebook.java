...
@SupportsBatching
@Tags({"Facebook", "Get", "social media"})
@InputRequirement(Requirement.INPUT_ALLOWED)
@CapabilityDescription("Processor to retrieve data from Facebook. "
...
public final class GetFacebook extends AbstractProcessor {

    public static final String DEFAULT_CONTENT_TYPE = "application/json";  
   public static final PropertyDescriptor FACEBOOK_HOST = new PropertyDescriptor
            .Builder().name("Facebook Host")
            .description("Facebook API url")
            .required(true)
            .defaultValue("https://graph.facebook.com/v2.12")
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
    public static final PropertyDescriptor END_POINT = new PropertyDescriptor
            .Builder().name("API EndPoint")
            .description("Facebook API end point")
            .required(true)
            .defaultValue("me?fields=id,name")
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
    ...
    public static final Relationship REL_SUCCESS = new Relationship.Builder()
            .name("success")
            .description("FlowFiles are routed to success if data retrieved from Facebook successfully")
            .build();

    public static final Relationship REL_FAILURE = new Relationship.Builder()
            .name("failure")
            .description("FlowFiles are routed to failure if unable to get data from Facebook")
            .build();
  private static final List<PropertyDescriptor> PROPERTIES = Collections.unmodifiableList(Arrays.asList(
    ...
    public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException {
        ...
        String hostUrl=context.getProperty(FACEBOOK_HOST).evaluateAttributeExpressions().getValue();
