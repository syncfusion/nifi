 ...
 */
package org.apache.nifi.postgresqlserver;
 ...
 *
 */
@Tags({ "dbcp", "jdbc", "database", "connection", "pooling", "store", "PostgreSQL" })
@CapabilityDescription("Provides Database Connection Pooling Service with PostgreSQL server.")
...
public class PostgreSQL extends AbstractControllerService implements PostgreSQLService {

    public static final PropertyDescriptor SERVER_NAME = new PropertyDescriptor.Builder()
        .name("Server Name")
        .description("PostgreSQL Server Name. May contain hostname or IP address")
        .defaultValue(null)
    ...
    public static final PropertyDescriptor DB_DRIVER_LOCATION = new PropertyDescriptor.Builder()
        .name("PostgreSQL-database-driver-locations")
        ...
        .defaultValue(SQLUpdater.getValue("PostgreSQL"))
        .required(false)
    ...
    public void onConfigured(final ConfigurationContext context) throws InitializationException {
        ...
        final String dburl = "jdbc:postgresql://"+ServerName+":"+serverPort+"/"+DbName;
