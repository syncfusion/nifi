...
2. The WAR needs to contain a `dataintegration-content-viewer` file in the META-INF directory, which lists the supported content types.
...
│               └── css
│               └── META-INF
│               │   └── dataintegration-content-viewer
│               └── WEB-INF
│
├── nifi-standard-nar
│
...
with the contents of `dataintegration-content-viewer` as follows:
------------------------------------------------------------------------------------------------
application/xml
application/json
text/plain
